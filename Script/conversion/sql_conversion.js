...
const sequelize = new Sequelize ({
	dialect : "sqlite" ,
	storage : "staff_database.sqlite", // file name
    define: { 
...
let role_descriptions = {
	trialhelper: 'A <a class="role_link" href="">helper</a> over time with the same rights as a <a class="role_link">helper</a> to prove that they can be a good <a class="role_link">helper</a>.<br><br> After a few days, higher ranked staff members will decide whether this person becomes a normal <a class="role_link">helper</a> or not. <br><br> Applications for trial helpers are sometimes opened in <span style="color: #7289da">#community-announcements.</span>',
	...
	minimod: 'Minimods are users who have passed the <a class="role_link">trial minimod</a> phase. Minimods have the same tasks as <a class="role_link">helper</a> but can also take care of misbehaving users.<br><br>They also handle submissions for <span style="color: #7289da">#role-vote</span> and <span style="color: #7289da">#design-vote</span>.',
	...
	megamod: 'They are the admins of the server. They manage all staff and focus on things such as rules, bans from the server, and other related topics. Manager is the highest rank for Discord staff and also the hardest one to get.',
...
let exclude_show_higher = ["trialhelper","helper","trialminimod","minimod", "guardianmanagerhelper", "mentormanagerhelper"]
...
whole_staff_list[0].forEach(staff => {
	let sane_staff = sanitize_object(staff);

...
let role_descriptions = {
	trialhelper: 'A <a class="role_link" href="">helper</a> over time with the same rights as a <a class="role_link">helper</a> to prove that they can be a good <a class="role_link">helper</a>.<br><br> After a few days, higher ranked staff members will decide whether this person becomes a normal <a class="role_link">helper</a> or not. <br><br> Applications for trial helpers are sometimes opened in <span style="color: #7289da">#discord-announcements.</span>',
